 ...
 * Copyright (c) 2009-2011 by BUGO, Inc. All Rights Reserved.
...
//@interface BUGOObject : NSObject
//@end

@interface BUGOObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[BUGOObject class]])
		{
			for (NSString *key in [[(BUGOObject*)o modules] allKeys])
			{
