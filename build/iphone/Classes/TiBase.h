...
// in simulator we redefine to format for BUGO Developer console
...
{\
	NSString * exceptionName = [@"org.bugo." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.bugo";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIBUGONativeItemNone = -1, 
	UIBUGONativeItemSpinner = -2,
	UIBUGONativeItemProgressBar = -3,
	
	UIBUGONativeItemSlider = -4,
	UIBUGONativeItemSwitch = -5,
	UIBUGONativeItemMultiButton = -6,
	UIBUGONativeItemSegmented = -7,
	
	UIBUGONativeItemTextView = -8,
	UIBUGONativeItemTextField = -9,
	UIBUGONativeItemSearchBar = -10,
	
	UIBUGONativeItemPicker = -11,
	UIBUGONativeItemDatePicker = -12,
	
	UIBUGONativeItemInfoLight = -13,
	UIBUGONativeItemInfoDark = -14,
	
	UIBUGONativeItemDisclosure = -15,
	
	UIBUGONativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all BUGO instances of
