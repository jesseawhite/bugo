...
/**
 The base class for all BUGO modules
 */
...
/**
 BUGO Platform calls this method on startup.
 */
-(void)startup;

/**
 BUGO Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 BUGO Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 BUGO Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 BUGO Platform calls this method on resume.
 @param sender The sender of the event.
 */
